...
export default function DemoHome() {
  ...
  // Mock data - Trilhas de aprendizado
  const learningPaths = [
    {
      id: "iniciante",
      title: "Trilha Iniciante",
      description: "Fundamentos de programação e ferramentas essenciais",
      progress: 65,
      modules: 8,
      completedModules: 5,
      totalSteps: 24,
    ...
    },
    {
      ...
      description: "Desenvolvimento web e bancos de dados",
      progress: 40,
      modules: 10,
      completedModules: 4,
      totalSteps: 32,
    ...
    },
    {
      ...
      description: "Arquitetura, DevOps e práticas avançadas",
      progress: 15,
      modules: 12,
      completedModules: 2,
      totalSteps: 40,
  ...
  // Mock data - Badges conquistados
  const badges = [
    { id: 1, name: "Primeiro Passo", description: "Completou o primeiro módulo", icon: "🎯", earned: true },
    { id: 2, name: "Git Master", description: "Dominou os comandos Git", icon: "🏆", earned: true },
    { id: 3, name: "Docker Ninja", description: "Completou todos exercícios Docker", icon: "🐳", earned: true },
    { id: 4, name: "Code Warrior", description: "100 exercícios concluídos", icon: "⚔️", earned: false },
    { id: 5, name: "Team Player", description: "Ajudou 5 colegas", icon: "🤝", earned: false },
    { id: 6, name: "Speed Runner", description: "Completou trilha em tempo recorde", icon: "⚡", earned: false }
  ];

  // Mock data - Leaderboard
  const leaderboard = [
    { rank: 1, name: "João Silva", points: 2850, level: 12, avatar: "👨‍💻" },
    { rank: 2, name: "Maria Santos", points: 2640, level: 11, avatar: "👩‍💻" },
    { rank: 3, name: "Pedro Costa", points: 2420, level: 11, avatar: "👨‍🔧" },
    { rank: 4, name: "Ana Oliveira", points: 2180, level: 10, avatar: "👩‍🎓" },
    { rank: 5, name: "Carlos Mendes", points: 1950, level: 9, avatar: "👨‍🚀" }
  ];

  // Mock data - Estatísticas do usuário
  const userStats = {
    name: "João Silva",
    level: 12,
    points: 2850,
                  ...
                  <Card key={path.id} className="border-0 shadow-lg hover:shadow-xl transition-all cursor-pointer group">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button 
                        ...
                        variant="default"
                        onClick={() => setLocation(`/trilha/${path.id}`)}
                      >
